...
/****** Object:  View [dbo].[View_ProductoPorSucursal]    Script Date: 06/06/2016 05:26:31 p.m. ******/
SET ANSI_NULLS ON
GO
...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      Begin Tables = 
         Begin Table = "PRODUCTO"
            ...
            TopColumn = 0
         End
         Begin Table = "PRODUCTO_POR_SUCURSAL"
            Begin Extent = 
               Top = 6
               Left = 246
               Bottom = 136
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'View_ProductoPorSucursal'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'View_ProductoPorSucursal'
GO
